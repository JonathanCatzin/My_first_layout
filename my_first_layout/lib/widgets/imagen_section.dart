...
class _ImagenSectionState extends State<ImagenSection> {
  List imageList = [
    {"id": 1, "image_path": 'assets/images/lake.jpg'},
    {"id": 2, "image_path": 'assets/images/lake2.jpg'},
    {"id": 3, "image_path": 'assets/images/lake3.jpg'}
  ];
            ...
            child: Row(
              ...
              children: imageList.asMap().entries.map((entry) {
                return GestureDetector(
                  ...
                  child: Container(
                    width:  7.0, //currentIndex == entry.key ? 17 :
                    height: 7.0,
